...
export type TokenInstanceId = string & {
    readonly __brand: 'TokenInstanceId';
};
/** Token class ID (for SFT - groups of fungible tokens) */
export type TokenClassId = string & {
    readonly __brand: 'TokenClassId';
};
/** Token type discriminator */
export type TokenType = 'FT' | 'NFT' | 'SFT';
/** Token standard versions */
export declare const TokenStandard: {
    readonly FT_V1: "WSTF-FT-V1";
    readonly NFT_V1: "WSTF-NFT-V1";
    readonly SFT_V1: "WSTF-SFT-V1";
};
...
export declare function isFT(token: AnyToken): token is FungibleToken;
export declare function isNFT(token: AnyToken): token is NFTCollection;
export declare function isSFT(token: AnyToken): token is SFTCollection;
export declare function makeTokenId(raw: string): TokenId;
export declare function makeTokenInstanceId(raw: string): TokenInstanceId;
export declare function makeTokenClassId(raw: string): TokenClassId;
/** Transfer request */
...
export declare function isValidRoyaltyBps(bps: number): boolean;
/** Maximum decimals allowed */
export declare const MAX_DECIMALS = 18;
/** Maximum royalty (100%) */
export declare const MAX_ROYALTY_BPS = 10000;
/** Zero address for burns */
export declare const ZERO_ADDRESS = "0x0000000000000000000000000000000000000000";
/** Token event types */
export type TokenEventType = 'Transfer' | 'Approval' | 'ApprovalForAll' | 'Mint' | 'Burn' | 'Pause' | 'Unpause' | 'MetadataUpdate' | 'OwnershipTransfer';
/** Token event */
